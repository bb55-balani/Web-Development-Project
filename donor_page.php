                ...
                <nav class="navbar fixed-top navbar-expand-lg navbar-light p-0 px-2 rounded"
                    ...
                    <div class="collapse navbar-collapse" id="mynav">
                        <ul class="navbar-nav nav-pills mr-auto">
                            ...
                            <li class="nav-item">
                                <a href="" class="nav-link text-white">Donation History</a>
                            </li>
                            <li class="nav-item">
                                <a href="" class="nav-link text-white">Certificates</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <!-- <button class="btn btn-dark btn-lg p-3 ml-md-none ml-n1 mb-2">
                            <a href="logout_page.php">LOGOUT</a>
                            
                        </button> -->

                        <button type="button" onclick="end_session()"
                            class="btn btn-dark btn-lg font-weight-bolder font-size-larger" data-bs-toggle="modal"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="end_session()" class="btn btn-primary">
                                            Okay!
                                        </button>
                                        <script>
        ...
        <div class="row no-gutters">
            <div class="col-lg-8 bg-dark text-white rounded mt-lg-none mt-2 p-2">
                <p class="display-3 ml-2">
                    SAVE LIFE<i class="bi bi-droplet display-2"></i><br>DONATE BLOOD
                </p>
                <p class="ml-2">
                    ...
                    <br><br>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Maiores aut, minus laborum eaque esse nam
                    laboriosam fugiat! Eligendi, accusamus nulla saepe tenetur odit ea esse error aspernatur debitis,
                    ipsa consequatur?
                </p>
                <a href="health_form.php"><button class="ml-2 btn btn-success btn-lg mr-3 mb-xl-2 mb-2">DONATE
                        NOW</button><button class="btn btn-danger btn-lg mb-2">Get Help!</button></a>
            </div>
            <div class="col-lg-4 mt-lg-none mt-2">
                <img src="images/child1.jpg" alt="" class="img-fluid rounded" id="donorImg" width="100%">
            </div>
        </div>
    </div>

    <h2 class="mt-4 font-weight-bold text-center display-4" style="color:#DF3C5F;">Do's And Dont's</h2>
